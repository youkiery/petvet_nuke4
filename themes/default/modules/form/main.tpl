...
<div class="tab-content">
  ...
  <div id="menu1" class="tab-pane">
    ...
    <div class="row form-group boxed box-2 box-2-1 box-3 box-3-2 box-4 box-4-1 box-5 box-5-14">
    ...
    <div class="row form-group boxed box-2 box-2-2 box-4 box-4-12">
    ...
    <div class="row form-group boxed box-1 box-1-3 box-2 box-2-3 box-3 box-3-1 box-4 box-4-13 box-5 box-5-9">
    ...
    <div class="row form-group boxed box-4 box-4-10">
      <label class="col-sm-6">
        Ngày lấy mẫu
      </label>
      <div class="relative col-sm-12">
    ...
    <div class="row form-group boxed box-4 box-4-11">
      <label class="col-sm-6">
        Người lấy mẫu
      </label>
      <div class="relative col-sm-12">
    ...
    <div class="row form-group boxed box-2 box-2-6 box-4 box-4-14">
      <label class="col-sm-6">
        Người nhận mẫu
      </label>
      <div class="relative col-sm-12">
    ...
    <div class="form-group row boxed box-1 box-1-10 box-2 box-2-13 box-3 box-3-7 box-4 box-4-7 box-5 box-5-7">
    ...
    <div class="boxed box-1 box-1-11 box-2 box-2-9 box-3 box-3-6 box-4 box-4-6 box-5 box-5-6">
    ...
    <div class="form-group row boxed box-1 box-1-12 box-2 box-2-10 box-3 box-3-8 box-4 box-4-5">
    ...
    <div class="form-group row boxed box-1 box-1-13 box-2 box-2-15 box-3 box-3-9 box-4 box-4-8 box-5 box-5-8">
    ...
    <div class="form-group row boxed box-2 box-2-14 box-4 box-4-9">
    ...
    <div class="row form-group boxed box-2 box-2-16 box-3 box-3-10">
    ...
    <div class="boxed box-2 box-2-17">
    ...
    <div class="boxed box-1 box-1-14 box-2 box-2-19 box-3 box-3-11 box-4 box-4-16 box-5 box-5-11">
      <label>
        Yêu cầu xét nghiệm
    ...
    <div class="row form-group boxed box-2 box-2-21">
    ...
    <div class="row form-group boxed box-3 box-3-12">
      <label class="col-sm-6">
        Yêu cầu khác
      </label>
      <div class="col-sm-20">
    ...
    <div class="row form-group boxed box-5 box-5-12 box-4 box-4-17">
      <label class="col-sm-6">
        Ghi chú
      </label>
      <div class="col-sm-20">
    ...
    <div class="row form-group boxed box-4 box-4-18">
      <label class="col-sm-6">
        Ngày phân tích
      </label>
      <div class="relative col-sm-12">
    ...
    <div class="row form-group boxed box-5 box-5-10">
      <label class="col-sm-6">
        Mục đích xét nghiệm
      </label>
      <div class="col-sm-20">
      ...
      if (Object.keys(data).length) {
        ...
        switch (id) {
          case 1:
            ...
            html = html.replace('(form)', (data['form'].join('<br>') + '<br>Số lượng mẫu: ' + data['number'] + ', loại mẫu: ' + (data['type']['index'] == 5 ? data['type']['value'] : trim($("#type-" + data['type']['index']).text())) + ', loài động vật: ' + data['sample'] + '<br> Ký hiệu mẫu: ' + data['samplecode'] + '<br>Yêu cầu xét nghiệm:<br>' + (data['exam'].length > 1 ? data['exam'].join('<br>') : data['exams'].join('<br>'))))
          break;
          case 2:
