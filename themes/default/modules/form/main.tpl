...
<script>
  ...
  var former = {
    ...
    5: '<table><tr><td class="cell-center p12" style="position: relative;"> <div style="    position: absolute; border-top: 1px solid black; width: 70px; top: 45px; left: 82px;"></div> CỤC THÚ Y <br> <b> CHI CỤC THÚ Y VÙNG V </b> <div style="margin-top: 10px; "></div> <span class="p14"> Số &emsp;/TYV5-TH </span> </td><td class="cell-center" style="position: relative"><div style="position: absolute; border-top: 1px solid black; width: 205px; height: 100px; top: 41px; left: 95px;"></div> <span class="p12">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</span> <br> <b class="p13"> Độc lập - Tự do - Hạnh phúc </b> <div style="margin-top: 15px;"></div> <span class="p14"> <i> Đăk Lăk, ngày noticetime-0, tháng noticetime-1, năm noticetime-2 </i> </span> </td></tr> </table><p class="text-center p15" style="padding-top: 5px;"> <b> THÔNG BÁO </b> </p><p class="text-center p15" style="padding-bottom: 15px;"> Kết quả xét nghiệm </p> <p class="p14">&emsp;&emsp; Chi cụ thú y vùng V thông báo kết quả xét nghiệm được thực hiện tại Trạm Chẩn đoán xét nghiệm bệnh động vật (trực thuộc Chi cục Thú y vùng V) như sau: </p> <p class="p14"> &emsp;&emsp; Tên khách hàng: senderemploy  </p> <p class="p14"> &emsp;&emsp; Địa chỉ: xaddress </p> owner <p style="width: 60%; float: left;" class="p14"> &emsp;&emsp; Loài động vật được lấy mẫu: (sample)</p><p style="width: 35%; float: left; " class="p14">Loại mẫu: (sampletype)</p> <p style="clear: left; width: 60%; float: left;" class="p14"> &emsp;&emsp; Số lượng mẫu: number ((numberword)) mẫu </p> <p style="width: 35%; float: left;" class="p14">Số mẫu xét nghiệm: (examsample)</p> <p class="p14" style="clear: left;"> &emsp;&emsp; Ký hiệu mẫu: samplecode </p> <p class="p14"> &emsp;&emsp; Ngày nhận mẫu: sampletime </p> target <p class="p14"> &emsp;&emsp; <b> <i> <u> Chỉ tiêu xét nghiệm: </u> </i> </b> </p><div class="p14">(exam)</div>note<p class="p14"> &emsp;&emsp; <b> <u> Kết quả: </u> </b> </p><div class="p14">result</div><p class="p14"> <i> &emsp;&emsp;(Chi tiết xem phiếu kết quả xét nghiệm số: xcode-0/xcode-1/xcode-2.CĐXN của trạm chuẩn đoán xét nghiệm bệnh động vật)./. </i></p><div style="width: 60%; float: left;"><b class="p12"> <b> <i> Nơi nhận: </i> </b> </b> <p class="p11"> receivedis </p></div> <div style="width: 40%; float: left;" class="text-center p14"><b> CHI CỤC TRƯỞNG <br><br><br><br><br> receiveleader </b></td></tr></table>'
  }
