...
<div class="tab-content">
  ...
  <div id="menu1" class="tab-pane">
    ...
    <div class="row form-group boxed box-1 box-3 box-4">
    ...
    <div class="row form-group boxed box-3 box-4 box-5">
      <label class="col-sm-4">
        Khách hàng
      </label>
      <div class="relative col-sm-10">
    ...
    <div class="row form-group boxed box-3 box-4">
      ...
      <div class="col-sm-20">
        <input type="text" class="form-control" id="form-insert-result" autocomplete="off">
      </div>
    </div>
      ...
      if (Object.keys(data).length) {
        ...
        switch (id) {
          ...
          case 5:
            ...
            html = html.replace('(parse)', parse)
            html = html.replace('(result)', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + data['target'].replace('\n', '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'))
            html = html.replace('(note)', data['note'].replace('\n', '<br>'))
          break;
        }
