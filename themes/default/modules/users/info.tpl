  ...
  <div class="page">
    ...
    <div class="tab-content margin-bottom-lg">
      ...
      <div id="edit_basic" class="tab-pane fade {TAB_BASIC_ACTIVE}">
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            <form action="{EDITINFO_FORM}/basic" method="post" role="form" class="form-horizontal"
              onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
              ...
              <div class="form-detail">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" class="form-control {FIELD.required} {FIELD.class}" placeholder="{FIELD.title}"
                      value="{FIELD.value}" name="last_name" maxlength="{FIELD.max_length}"
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" class="form-control {FIELD.required} {FIELD.class}" placeholder="{FIELD.title}"
                      value="{FIELD.value}" name="first_name" maxlength="{FIELD.max_length}"
                      onkeypress="validErrorHidden(this);" data-mess="">
                  </div>
                </div>
                <!-- END: show_first_name -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="clearfix radio-box {FIELD.required} {FIELD.class}" data-mess="">
                      <!-- BEGIN: gender -->
                      <label class="radio-box"> <input type="radio" name="gender" value="{GENDER.key}" {GENDER.checked}
                          class="{FIELD.class}" onclick="validErrorHidden(this,5);"> {GENDER.title} </label>
                      <!-- END: gender -->
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control calendar-icon datepicker {FIELD.required} {FIELD.class}"
                      name="birthday" value="{FIELD.value}" readonly="readonly" onfocus="datepickerShow(this);"
                      data-mess="">
                  </div>
                </div>
                <!-- END: show_birthday -->
                ...
                <div class="form-group">
                  <label for="birthday" class="control-label col-md-6 text-normal">{FIELD.title}</label>
                  <div class="col-md-12">
                    <textarea class="form-control {FIELD.required} {FIELD.class}" placeholder="{FIELD.title}" name="sig"
                      onkeypress="validErrorHidden(this);" data-mess="">{FIELD.value}</textarea>
                  </div>
                </div>
                <!-- END: show_sig -->
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="button" value="{GLANG.reset}" class="btn btn-default"
        ...
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            <div class="margin-bottom">
              <img id="myavatar" class="img-thumbnail bg-gainsboro" src="{DATA.photo}" width="{DATA.photoWidth}"
                height="{DATA.photoHeight}" data-default="{AVATAR_DEFAULT}" />
            </div>
            <div>
              <button type="button" class="btn btn-primary btn-xs margin-right-sm"
                onclick="changeAvatar('{URL_AVATAR}');">
                {LANG.change_avatar}
              </button>
              <button type="button" class="btn btn-danger btn-xs" id="delavatar"
                onclick="deleteAvatar('#myavatar','{DATA.checkss}',this)" {DATA.imgDisabled}>
                {GLANG.delete}
              </button>
            </div>
          </div>
      ...
      <div id="edit_username" class="tab-pane fade {TAB_USERNAME_ACTIVE}">
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            ...
            <form action="{EDITINFO_FORM}/username" method="post" role="form" class="form-horizontal{FORM_HIDDEN}"
              onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
              ...
              <div class="form-detail">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" class="required form-control" placeholder="{LANG.newlogin}" value=""
                      name="username" maxlength="{NICK_MAXLENGTH}"
                      data-pattern="/^(.){{NICK_MINLENGTH},{NICK_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{GLANG.username_empty}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="password" autocomplete="off" class="required form-control"
                      placeholder="{GLANG.password}" value="" name="password" maxlength="{PASS_MAXLENGTH}"
                      data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{GLANG.password_empty}">
                  </div>
                </div>
      ...
      <div id="edit_email" class="tab-pane fade {TAB_EMAIL_ACTIVE}">
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            ...
            <form action="{EDITINFO_FORM}/email" method="post" role="form" class="form-horizontal{FORM_HIDDEN}"
              onsubmit="return changemail_validForm(this);" autocomplete="off" novalidate>
              ...
              <div class="form-detail">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="email" class="required form-control" placeholder="{LANG.newemail}" value=""
                      name="email" maxlength="100" onkeypress="validErrorHidden(this);" data-mess="{GLANG.email_empty}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="{LANG.verifykey}" value="" name="verifykey"
                        maxlength="32" data-pattern="/^[a-zA-Z0-9]{32,32}$/" onkeypress="validErrorHidden(this);"
                        data-mess="{LANG.verifykey_empty}">
      ...
      <div id="edit_password" class="tab-pane fade {TAB_PASSWORD_ACTIVE}">
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            <form action="{EDITINFO_FORM}/password" method="post" role="form" class="form-horizontal"
              onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
              <div class="nv-info margin-bottom" data-default="" style="display:none"></div>
              ...
              <div class="form-detail">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="password" autocomplete="off" class="required form-control"
                      placeholder="{LANG.pass_old}" value="" name="nv_password" maxlength="{PASS_MAXLENGTH}"
                      data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{GLANG.required}">
                  </div>
                </div>
                <!-- END: is_old_pass -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="password" autocomplete="off" class="required form-control"
                      placeholder="{LANG.pass_new}" value="" name="new_password" maxlength="{PASS_MAXLENGTH}"
                      data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{LANG.required}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="password" autocomplete="off" class="required form-control"
                      placeholder="{LANG.pass_new_re}" value="" name="re_password" maxlength="{PASS_MAXLENGTH}"
                      data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{LANG.required}">
                  </div>
                </div>
      ...
      <div id="edit_question" class="tab-pane fade {TAB_QUESTION_ACTIVE}">
        <div class="page panel panel-default">
          <div class="panel-body bg-lavender">
            ...
            <form action="{EDITINFO_FORM}/question" method="post" role="form" class="form-horizontal{FORM_HIDDEN}"
              onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
              ...
              <div class="form-detail">
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="password" autocomplete="off" class="required form-control"
                      placeholder="{LANG.password}" value="" name="nv_password" maxlength="{PASS_MAXLENGTH}"
                      data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);"
                      data-mess="{GLANG.password_empty}">
                  </div>
                </div>
                ...
                <div class="form-group rel">
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      <input type="text" class="form-control {FIELD.required} {FIELD.class}" placeholder="{FIELD.title}"
                        value="" name="question" maxlength="{FIELD.max_length}"
                        data-pattern="/^(.){{FIELD.min_length},}$/" onkeypress="validErrorHidden(this);" data-mess="{LANG.your_question_empty}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-14">
                                    <div class="input-group">
                                        ...
                                        <input type="password" autocomplete="off" class="required form-control" placeholder="{GLANG.password}" value="" name="nv_password" maxlength="{PASS_MAXLENGTH}" data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/"
                        onkeypress="validErrorHidden(this);" data-mess="{GLANG.password_empty}">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-14">
                    <div class="input-group">
                      ...
                      <input type="text" class="required form-control" placeholder="{LANG.safe_key}" value=""
                        name="safe_key" maxlength="32" data-pattern="/^[a-zA-Z0-9]{32,32}$/"
                        onkeypress="validErrorHidden(this);" data-mess="{LANG.required}">
                      <span class="input-group-btn"><input type="button" value="{LANG.verifykey_send}"
                          class="safekeySend btn btn-warning" onclick="safekeySend(this.form);" /></span>
                    </div>
                  </div>
                </div>
