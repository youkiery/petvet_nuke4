...
$xtpl = new XTemplate("redrug.tpl", NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/" . $module_file);
...
$xtpl->assign("content", user_redrug());
