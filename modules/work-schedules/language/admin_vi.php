...
$lang_module['custom'] = 'Thêm khách hàng';
$lang_module['ae_id_requires'] = 'Là phần bắt buộc nhập';
$lang_module['ae_info'] = 'Là phần bắt buộc nhập';
$lang_module['customer_name'] = 'Tên khách hàng/công ty';
$lang_module['customer_number'] = 'Số điện thoại';
$lang_module['customer_address'] = 'Địa chỉ';
$lang_module['note_custom_name'] = 'Tên khách hàng, tối đa 200 kí tự';
$lang_module['note_custom_number'] = 'số điện thoại, tối đa 20 kí tự';
$lang_module['note_custom_address'] = 'Địa chỉ khách hàng, tối đa 200 kí tự';
$lang_module['custom_submit'] = 'Thêm khách hàng';

$lang_module['depart_manage'] = 'Quản lý phòng ban';
$lang_module['employ_manage'] = 'Quản lý nhân viên';
$lang_module['customer_manage'] = 'Quản lý khách hàng';
$lang_module['work_manage'] = 'Quản lý công việc';
...
$lang_module['depart_name'] = 'Tên phòng ban';
$lang_module['depart_chose'] = 'Chọn vào phòng ban';
$lang_module['depart_searchkey'] = 'Nhập từ khóa tìm kiếm';
$lang_module['depart_employ_name'] = 'Tên nhân viên';
$lang_module['depart_employ_username'] = 'Tên tài khoản';
$lang_module['depart_employ_role'] = 'Chức vụ';
$lang_module['depart_blank'] = 'Không được để trống tên phòng ban';
$lang_module['depart_insert_success'] = 'Đã thêm phòng ban';
$lang_module['depart_insert_fail'] = 'Vì lý do nào đó, phòng ban chưa được thêm';
$lang_module['depart_missing'] = 'Phòng ban không tồn tại hoặc có lỗi đã xảy ra';

$lang_module['customer_edit'] = 'Sửa khách hàng';
$lang_module['customer_name'] = 'Tên khách hàng';
$lang_module['customer_submit'] = 'Thêm khách hàng';
$lang_module['customer_remove'] = 'Xóa khách hàng này chứ?';
...
$lang_module['employ_depart'] = 'Phòng ban';
$lang_module['employ_remove'] = 'Xác nhận xóa nhân viên';
$lang_module['employ_username'] = 'Tên tài khoản';
$lang_module['employ_name'] = 'Tên nhân viên';
$lang_module['employ_roles'] = 'Thuộc các phòng ban';
$lang_module['employ_searchkey'] = 'Nhập từ khóa tìm kiếm nhân viên';
$lang_module['employ_search'] = 'Tìm kiếm nhân viên';

$lang_module['index'] = 'STT';
$lang_module['g_edit'] = 'Sửa';
$lang_module['g_remove'] = 'Xóa';
$lang_module['g_cencal'] = 'Hủy';
$lang_module['g_filter'] = 'Lọc';
$lang_module['g_saved'] = 'Đã lưu';
$lang_module['g_time'] = 'Lọc ngày';
$lang_module['g_starttime'] = 'Từ ngày';
