...
$xtpl2 = new XTemplate('work-list.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $module_file);
$xtpl2->assign('lang', $lang_module);
$xtpl2->parse('main');

$xtpl->assign('content', $xtpl2->text());
