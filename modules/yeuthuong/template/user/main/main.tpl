...
<div class="container" style="margin-top: 20px; margin-bottom: 20px; ">
  ...
  <div class="box-bordered" style="max-width: 500px;">
    <div class="text-center">
      <img class="banner" src="/assets/images/banner-2.jpg">
      <p style="color: green; font-size: 1.2em;"> <b> THANHXUANPET NHA TRANG </b> </p>
    </div>
    <p>Địa chỉ: 142 Ngô Gia Tự, Phước Tiến, Nha Trang </p>
    <p>Số điện thoại: 0258.2200.025 </p>
    <p>Facebook: <a href="https://facebook.com/thanhxuanpet">Bệnh viện thú cưng</a></p>
  </div>
</div>
