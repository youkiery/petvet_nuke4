  ...
  switch ($action) {
    case 'getcustomer':
      $key = $nv_Request->get_string("key", "get/post", "");
        $xtpl = new XTemplate("spa-suggest.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
    ...
    case 'get_detail':
      ...
      if (!empty($id)) {
        $xtpl = new XTemplate("spa-check.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
        $index = 1;
...
$xtpl = new XTemplate("spa.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
...
$xtpl2 = new XTemplate("spa-check.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
$index = 1;
