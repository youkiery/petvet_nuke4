...
$xtpl = new XTemplate("drug.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
...
function admin_drug() {
	...
	$xtpl = new XTemplate("drug-list.tpl", NV_ROOTDIR . "/themes/" . $global_config['admin_theme'] . "/modules/" . $module_file);
	$xtpl->assign("lang", $lang_module);
