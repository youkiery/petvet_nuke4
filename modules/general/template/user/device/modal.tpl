<!-- BEGIN: main -->
<div class="modal" id="manual-modal" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="form-group" id="manual-content"> </div>
      </div>
    </div>
  </div>
</div>

<div class="modal" id="report-content-modal" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <div class="form-group">
        ...
        <div class="form-group" id="report-content-content"> </div>
      </div>
    </div>
  </div>
</div>
